  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ExamsSourceEntity: obx_int.EntityDefinition<ExamsSourceEntity>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final examIdParam = const fb.StringReader(
          asciiOptimization: true,
...
class ExamsSourceEntity_ {
  ...
  static final id = obx.QueryIntegerProperty<ExamsSourceEntity>(
    _entities[0].properties[0],
  );

  /// See [ExamsSourceEntity.version].
  static final version = obx.QueryIntegerProperty<ExamsSourceEntity>(
    _entities[0].properties[1],
  );

  /// See [ExamsSourceEntity.path].
  static final path = obx.QueryStringProperty<ExamsSourceEntity>(
    _entities[0].properties[2],
  );

  /// See [ExamsSourceEntity.examId].
  static final examId = obx.QueryStringProperty<ExamsSourceEntity>(
    _entities[0].properties[3],
  );

  /// See [ExamsSourceEntity.data].
  static final data = obx.QueryStringProperty<ExamsSourceEntity>(
...
class LastCheckEntity_ {
  ...
  static final id = obx.QueryIntegerProperty<LastCheckEntity>(
